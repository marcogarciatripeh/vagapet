            ...
            <div class="nav-outer">
                ...
                <nav class="nav main-menu">
                    <ul class="navigation" id="navbar">
                        ...
                        <li><a href="{{ route('empresa.profissionais-favoritos') }}">Profissionais Favoritos</a></li>
            ...
            <div class="outer-box">
                ...
                <div class="dropdown dashboard-option">
                    <a class="dropdown-toggle" role="button" data-toggle="dropdown">
                        <img src="{{ auth()->check() ? (auth()->user()->avatar_url ?? asset('images/resource/company-6.png')) : asset('images/resource/company-6.png') }}" alt="avatar" class="thumb">
                        <span class="name">{{ auth()->check() ? (auth()->user()->name ?? 'Empresa') : 'Empresa' }}</span>
                    </a>
