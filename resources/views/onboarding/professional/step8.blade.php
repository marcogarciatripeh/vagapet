            ...
            <div class="tabs-box">
              ...
              <div class="widget-content">
                ...
                <div class="text-center">
                  ...
                  <div class="btn-box">
                    <a href="{{ route('onboarding.step7.professional') }}" class="theme-btn btn-style-one text-white">Voltar</a>
                    <a href="{{ route('professional.dashboard') }}" class="theme-btn btn-style-one text-white">Ir para o Dashboard</a>
                  </div>
                </div>
              </div>
            </div>
