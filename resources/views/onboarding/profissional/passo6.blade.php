          ...
          <div class="ls-widget">
            <div class="tabs-box">
              ...
              <div class="widget-content">
                ...
                <form class="default-form" method="POST" action="{{ route('onboarding.profissional.passo6.post') }}">
                  @csrf
                  <div class="row">
                    <div class="ls-widget">
                      <div class="tabs-box">
                        <div class="widget-title">
                          <h4>Portifólio e localização</h4>
                        </div>
                        <div class="widget-content">
                          <div class="row">
                            <div class="form-group col-lg-6 col-md-12">
                              <div class="uploading-outer">
                                <div class="uploadButton">
                                  ...
                                  <label class="uploadButton-button ripple-effect" for="upload">Adicionar Portfólio</label>
                  ...
                  <div class="row">
                    <div class="form-group col-lg-6 col-md-6">
                      <a href="{{ route('onboarding.profissional.passo5') }}" class="theme-btn btn-style-one">Voltar</a>
                    </div>
