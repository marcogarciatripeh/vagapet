...
@section('title', 'Onboarding Empresa - Passo 1')
                        ...
                        <div class="ls-widget">
                            <div class="tabs-box">
                                ...
                                <div class="widget-content">
                                    <form method="get" action="{{ route('onboarding.empresa.passo2') }}">
                                            ...
                                            <div class="radio-outer row justify-content-center">
                                                <div class="col-lg-3 profile-choice-box card bg-light m-1">
                                                    <div class="radio-box card-body pt-5 pb-5">
                                                        <input class="theme-btn btn-style-seven" type="radio" name="perfil" id="radio-1" value="profissional">
                                                        <label class="mb-0" for="radio-1"><span><i class="la la-user"></i> Profissional</span></label>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 profile-choice-box card bg-light m-1">
                                                    <div class="radio-box card-body pt-5 pb-5">
                                                        <input class="theme-btn btn-style-seven" type="radio" name="perfil" id="radio-2" value="empresa" checked>
