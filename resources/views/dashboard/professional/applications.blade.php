          ...
          <div class="ls-widget">
            <div class="tabs-box">
              ...
              <div class="widget-content">
                <div class="row">
                  <!-- Lista de vagas em cards (substitui a tabela) -->
                  <!-- Exemplo 1: Veterinário -->
                  <div class="job-block col-lg-6 col-md-12 col-sm-12">
                    <div class="inner-box">
                      <span class="badge text-bg-success text-white rounded-start-2" style="position:absolute; bottom:0; right:0;">Aprovado</span>
                      <div class="content">
                        ...
                        <ul class="job-info">
                          <!-- substituí "PetCare Prime" pelo total de candidaturas -->
                        ...
                        <div class="option-box">
                          <ul class="option-list">
                            <li class="m-0"><button data-text="Ver vaga"><span class="la la-eye"></span></button></li>
                            <li><button data-text="Editar detalhes"><span class="la la-pencil"></span></button></li>
                            <li><button data-text="Cancelar candidatura"><span class="la la-trash"></span></button></li>
                          </ul>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="job-block col-lg-6 col-md-12 col-sm-12">
                    <div class="inner-box">
                      <span class="badge text-bg-danger text-white rounded-start-2" style="position:absolute; bottom:0; right:0;">Não aceita</span>
                      <div class="content">
                        <span class="company-logo"><img src="{{ asset('images/resource/company-logo/1-2.png') }}" alt=""></span>
                  ...
                  <!-- Exemplo 4: Auxiliar de Limpeza -->
                  <div class="job-block col-lg-6 col-md-12 col-sm-12">
                    <div class="inner-box">
                      <span class="badge text-bg-success text-white rounded-start-2" style="position:absolute; bottom:0; right:0;">Aprovado</span>
                      <div class="content">
                        <span class="company-logo"><img src="{{ asset('images/resource/company-logo/1-2.png') }}" alt=""></span>
                        <h4><a href="#">Auxiliar de Limpeza – Amigão PetShop</a></h4>
                        <ul class="job-info">
